      ...
      <div className="p-4 flex h-[80vh] w-full flex-col items-center bg-gray-50 max-w-4xl mx-auto">
        ...
        <div className="flex space-x-4 mb-6">
          <button
            ...
            className={`flex items-center space-x-2 px-6 py-2 rounded-lg font-bold w-60 justify-center ${
              activeTab === 'profile' ? 'bg-[#603F26] text-white' : 'bg-white text-[#603F26] border border-[#603F26]'
            }`}
          >
            <img
          ...
          <button
            ...
            className={`flex items-center space-x-2 px-6 py-2 rounded-lg font-bold w-60 justify-center ${
              activeTab === 'privacy' ? 'bg-[#603F26] text-white' : 'bg-white text-[#603F26] border border-[#603F26]'
            }`}
          >
            <img
