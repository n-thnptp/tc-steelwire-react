...
const OrderStatusDetails = () => {
    ...
    const { order } = router.query; // Get order from query params

    // If the order was passed as a string, parse it
    ...
    const orderState = "paid"; // For testing
            ...
            <div className="p-8 w-[80%] bg-white">
                ...
                <div className="flex items-center justify-between mt-8 mb-4">
                    ...
                    <div className="flex flex-col items-center">
                        <div
                            className={`rounded-full w-6 h-6 flex items-center justify-center ${orderState === "paid" || orderState === "shipping" || orderState === "DeliverSuccess"
                        ...
                        <span
                            className={`mt-2 font-bold font-inter text-center ${orderState === "paid" || orderState === "shipping" || orderState === "DeliverSuccess"
                                ? "text-[#603F26]"
                                : "text-gray-500"
                                }`}
                        >
                    ...
                    <div className="flex flex-col items-center">
                        <div
                            className={`rounded-full w-6 h-6 flex items-center justify-center ${orderState === "shipping" || orderState === "DeliverSuccess"
                                ? "bg-[#603F26] text-white"
                                : "border border-[#603F26] bg-white"
                                }`}
                        >
                        ...
                        <span
                            className={`mt-2 font-bold font-inter text-center ${orderState === "shipping" || orderState === "DeliverSuccess"
                                ? "text-[#603F26]"
                                : "text-gray-500"
                                }`}
                        >
                    ...
                    <div className="flex flex-col items-center">
                        <div
                            className={`rounded-full w-6 h-6 flex items-center justify-center ${orderState === "DeliverSuccess"
                                ? "bg-[#603F26] text-white"
                                : "border border-[#603F26] bg-white"
                                }`}
                        >
                        ...
                        <span
                            className={`mt-2 font-bold font-inter text-center ${orderState === "DeliverSuccess"
                                ? "text-[#603F26]"
                                : "text-gray-500"
                                }`}
                        >
                ...
                <div className="flex justify-between mt-8">
                    ...
                    <button className="px-6 py-2 bg-[#CD3535] text-white font-bold font-inter rounded-[20px] w-[15%]">
                        CANCEL
                    </button>
                </div>
            </div>
