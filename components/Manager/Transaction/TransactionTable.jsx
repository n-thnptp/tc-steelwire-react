          ...
          <table className="min-w-full bg-white rounded-lg">
            <thead>
              <tr className="bg-[#D3D3D3] text-primary-700">
                ...
                <th className="py-3 px-4 text-center font-bold text-primary-700 font-inter">METHODS</th>
            ...
            <tbody>
              {sortedTransactions.map((transaction, index) => (
                <tr key={index} className="border-b h-16">
                  ...
                  <td className="py-3 px-4 text-primary-700 font-inter text-center font-bold">{transaction.method}</td>
